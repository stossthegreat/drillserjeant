...
const MENTORS = {
  ...
  'abraham-lincoln': {
    ...
    nudges: {
      low_progress: [
        "I am a slow walker, but I never walk backward. Keep moving forward.",
        "The best way to predict your future is to create it. Start now.",
        "Most folks are as happy as they make up their minds to be. Make up yours.",
        "Give me six hours to chop down a tree and I will spend the first four sharpening the axe."
      ],
      high_progress: [
        "Whatever you are, be a good one. You're doing excellent work.",
        "I do the very best I know how, the very best I can. As are you.",
        "Character is like a tree and reputation like a shadow. You're building strong character.",
        "Stand with anybody who stands right. Stand with him while he is right."
      ],
      streak_risk: [
        "A house divided against itself cannot stand. Unite your efforts.",
        "I have always found that mercy bears richer fruits than strict justice.",
        "The probability that we may fail ought not to deter us from the support of a cause we believe to be just."
      ]
    }
  },
  'confucius': {
    ...
    nudges: {
      ...
      high_progress: [
        ...
        "Real knowledge is to know the extent of one's ignorance. You show wisdom in your consistency.",
        "He who exercises government by means of his virtue may be compared to the north polar star.",
        "To see what is right and not do it is want of courage. You show great courage."
      ],
      streak_risk: [
        "Study the past if you would define the future. Learn from this moment.",
        "When anger rises, think of the consequences. Channel it into determination.",
        "The cautious seldom err. Be cautious but not paralyzed."
      ]
    }
  }
};
...
// Removed duplicate functions - kept the first instances above
